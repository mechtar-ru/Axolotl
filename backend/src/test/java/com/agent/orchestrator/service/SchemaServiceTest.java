...
class SchemaServiceTest {
    ...
    @BeforeEach
    void setUp() {
        schemaService = new SchemaService(schemaRepository, llmService, webSocketHandler, memPalaceClient, planService, settingsService, toolExecutor, metricsService, transformService);
    }
