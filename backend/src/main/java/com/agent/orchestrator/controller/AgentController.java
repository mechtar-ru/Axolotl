...
public class AgentController {
    ...
    private final com.agent.orchestrator.graph.repository.Neo4jSchemaRepository neo4jSchemaRepository;
    ...
    public AgentController(AgentService agentService, SchemaService schemaService,
                           ...
                           com.agent.orchestrator.graph.repository.Neo4jSchemaRepository neo4jSchemaRepository) {
    ...
    public SessionPlanResponse sessionPlan(
        ...
        try {
            ...
            if (plan != null && plan.getTasks() != null && !plan.getTasks().isEmpty()) {
                ...
                for (Task task : plan.getTasks()) {
                    context.append("- [").append(task.getStatus() == Task.TaskStatus.DONE ? "x" : " ")
        ...
        if (model == null || model.isBlank()) {
            try {
                model = settingsService.getSystemModel();
            } catch (Exception e) {
