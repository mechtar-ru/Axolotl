...
.fallback-node.selected { border-color: var(--accent); box-shadow: var(--shadow-glow-accent); }
...
.node-name-input { flex: 1; background: var(--bg-primary); border: 1px solid var(--node-fallback); color: var(--text-primary); border-radius: var(--radius-sm); padding: 2px 6px; font-size: var(--text-md); font-weight: bold; }
...
.fallback-hint { font-size: var(--text-xs); color: var(--node-fallback); margin-top: var(--space-1-5); font-style: italic; }
