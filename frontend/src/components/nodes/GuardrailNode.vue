...
.guardrail-node.selected { border-color: var(--accent-light); box-shadow: var(--shadow-glow-accent); }
...
.node-icon { font-size: var(--text-lg); display: flex; align-items: center; }
.node-name { flex: 1; font-weight: bold; color: var(--text-primary); cursor: pointer; }
.node-name-input { flex: 1; background: var(--bg-primary); border: 1px solid var(--node-guardrail); color: var(--text-primary); border-radius: var(--radius-sm); padding: 2px 6px; font-size: var(--text-sm); font-weight: bold; }
...
.mode-select { width: 100%; background: var(--bg-input); border: 1px solid var(--border-color); color: var(--text-primary); border-radius: var(--radius-sm); padding: var(--space-1); margin-top: var(--space-1); font-size: var(--text-xs); }
